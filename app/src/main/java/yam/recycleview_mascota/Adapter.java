...
public class Adapter extends RecyclerView.Adapter<Adapter.MascotaViewHolder> {
    ...
    public Adapter(List<Mascota> lista_Mascota) {
    ...
    /*public void onBindViewHolder (VH holder, int position) establece
      en el ViewHolder. Este recibe los datos correspondientes al elemento
      de la posición position.*/
    @Override
    public void onBindViewHolder(MascotaViewHolder mascotaViewHolder, int position){
        final Mascota mascota=lista_Mascota.get(position);
        ...
        mascotaViewHolder.whiteBone.setOnClickListener(new View.OnClickListener(){
            @Override
